~ function () {
    ...
    function s(a) {
        var e, b = Array(),
            d = (1 << c) - 1;
        for (e = 0; e < a.length * c; e += c) b[e >> 5] |= (a.charCodeAt(e / c) & d) << e % 32;
        return b
    }
    ...
    var a = 0,
        c = 8;
    "object" == typeof module && "object" == typeof module.exports && (module.exports.hex_md5 = d), "undefined" != typeof window && (window.hex_md5 = d)
}();